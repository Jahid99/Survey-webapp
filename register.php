    ...
    <div class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo SITE_URL;?>admin"><b>Survey System</b></a>
        </div>
        ...
        <div class="panel-heading">
                 <div class="panel-title text-center">
                    ...
                    <?php 
                        ...
                        $query = "SELECT * FROM username where Email = '$email' limit 1";
           $mailcheck = $db->select($query);
           if ($mailcheck != false) {
            echo "<span class='label label-danger'>Email Already exists  !!!</span><br><br>";
           }else{
             $query = "INSERT INTO   username(Email,Password) VALUES ('$email','$password')";
